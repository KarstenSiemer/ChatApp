...
<div class="flex flex-col min-h-screen max-h-screen">
	<nav class="navbar bg-base-100 border-b">
		<div class="flex-1">
			...
			<p class="px-2 font-semibold normal-case text-2xl">ChatApp</p>
		</div>
		<div class="flex-none">
			{#if !data.user}
	...
	<div class="py-4 flex-grow h-full sm:px-6 lg:px-8">
		<slot />
	</div>
	<div class="">
		<footer class="footer footer-center p-4 bg-neutral text-neutral-content">
			<div class="items-center grid-flow-col">
				...
				<p>Copyright © 2023 - All right reserved by SEKARMA</p>
			</div>
		</footer>
	</div>
</div>
